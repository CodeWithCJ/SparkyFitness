...
*   **Is SparkyFitness free? Why a custom license?**
    SparkyFitness uses a custom license to retain commercial hosting rights. Building and maintaining the project requires significant resources (hardware, developer accounts, infrastructure, AI tools, etc.). If companies commercially host the project, it is reasonable to ask them to obtain permission or contribute back.

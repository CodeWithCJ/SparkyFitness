...
*   **Is SparkyFitness free? Why a custom license?**
    I chose a custom license because I wanted to retain the commercial hosting rights. Building and maintaining SparkyFitness takes a significant amount of time and money (hardware, developer accounts, infrastructure, AI tools, etc.), and if companies commercially host the project, I think it's reasonable to ask them to obtain permission or contribute back.
    
    Recently, a few hosting providers started offering SparkyFitness. Some reached out to discuss a partnership and revenue sharing, while others did not. That reinforced my decision to keep commercial hosting under a separate license rather than adopting a standard open-source license that would give up that control.
    
    The intention isn't to stop people from using or self-hosting the project—it's to make sure that if SparkyFitness becomes commercially valuable, the project itself can benefit and remain sustainable. I'm always open to revisiting the licensing model as the project grows, but for now this feels like the fairest balance.

*   **Will SparkyFitness be free forever?**
    I have no plans to charge self-hosted users, but reality sucks. The costs of development infrastructure, Apple & Google developer license fees, and recurring monthly AI subscription bills are paid entirely out of my own pocket. If you find SparkyFitness valuable, consider sponsoring the project to help keep it alive and free for everyone.

...
### Option B — Reduced Privilege Setup (you create the App User manually)
...
> [!NOTE]
> **No extensions required.** As of this release, SparkyFitness no longer depends on `uuid-ossp`, `pgcrypto`, or `pg_stat_statements`.
>

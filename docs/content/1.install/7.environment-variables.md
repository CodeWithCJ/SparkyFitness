...
These variables configure code signing, bundle identifiers, and shared App Groups for the iOS mobile app ([`SparkyFitnessMobile`](/8.developer/1.getting-started)). They are only needed during local iOS development or when building for a physical device or simulator.

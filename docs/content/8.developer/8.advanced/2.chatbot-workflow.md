...
create table public.custom_categories (
  ...
  is_visible boolean not null default true, -- hidden categories are excluded from input screens and the daily summary
  sort_order integer not null default 100, -- ascending display order within a user
  created_at timestamp with time zone not null default now(),
  updated_at timestamp with time zone not null default now(),

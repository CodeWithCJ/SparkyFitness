...
| `exercise_entry_gps_points` | GPS trackpoints & second-by-second telemetry |
...
| `heart_rate_entries` | Intraday continuous heart rate readings |
| `hrv_entries` | Intraday & overnight HRV telemetry |
| `respiration_entries` | Intraday breathing rate telemetry |
| `spo2_entries` | Pulse ox SpO2 percentage telemetry |

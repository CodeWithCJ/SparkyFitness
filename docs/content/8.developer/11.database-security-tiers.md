...
| `cycle_daily_logs` | Per-day cycle logs (flow, period products, BBT, cervical mucus, moods, libido, notes) | Owner-Only | Owner-Only |
...
| `cycle_test_entries` | LH (OPK) and pregnancy (HPT) log entries | Owner-Only | Owner-Only |

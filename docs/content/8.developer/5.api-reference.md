...
*   **Request Body**:
    ...
    *   **Fields**:
        ...
        *   Other fields (optional, number): Measurement values. Masses are in kilograms, circumferences and height in centimetres, and `body_fat_percentage` / `body_water_percentage` are percentages.

...
const ALL_HEALTH_METRICS: HealthMetric[] = [
  ...
  { id: 'appleStandHours', label: 'Apple Stand Hours', stateKey: 'isAppleStandHoursSyncEnabled', preferenceKey: 'syncAppleStandTimeEnabled', recordType: 'AppleStandHour', unit: 'count', icon: require('../assets/icons/health-metrics/stand_time.png'), permissions: [{ accessType: 'read', recordType: 'AppleStandHour' }], type: 'apple_stand_hour', platforms: ['ios'], category: 'Apple', backgroundDeliveryFrequency: 'none', aggregationStrategy: 'sum' },

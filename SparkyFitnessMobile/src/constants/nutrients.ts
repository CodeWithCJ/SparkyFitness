...
export const NUTRIENT_META: Record<string, NutrientMeta> = {
  ...
  dietary_fiber: {
    labelKey: 'nutrients.fiber',
    defaultLabel: 'Fiber',
    unit: 'g',
  },
  saturated_fat: {
    labelKey: 'nutrients.saturatedFatShort',
    defaultLabel: 'Sat. Fat',
    unit: 'g',
  },
  polyunsaturated_fat: {
    labelKey: 'nutrients.polyunsaturatedFatShort',
    defaultLabel: 'Poly. Fat',
    unit: 'g',
  },
  monounsaturated_fat: {
    labelKey: 'nutrients.monounsaturatedFatShort',
    defaultLabel: 'Mono. Fat',
    unit: 'g',
  },
  trans_fat: {
    labelKey: 'nutrients.transFat',
    defaultLabel: 'Trans Fat',
    unit: 'g',
  },
  cholesterol: {
    labelKey: 'nutrients.cholesterol',
    defaultLabel: 'Cholesterol',
    unit: 'mg',
  },
  sodium: { labelKey: 'nutrients.sodium', defaultLabel: 'Sodium', unit: 'mg' },
  potassium: {
    labelKey: 'nutrients.potassium',
    defaultLabel: 'Potassium',
    unit: 'mg',
  },
  sugars: { labelKey: 'nutrients.sugars', defaultLabel: 'Sugars', unit: 'g' },
  vitamin_a: {
    labelKey: 'nutrients.vitaminA',
    defaultLabel: 'Vitamin A',
    unit: 'µg',
  },
  vitamin_c: {
    labelKey: 'nutrients.vitaminC',
    defaultLabel: 'Vitamin C',
    unit: 'mg',
  },
  calcium: {
    labelKey: 'nutrients.calcium',
 ...
 */
export const DEFAULT_SUMMARY_NUTRIENTS = [
  'protein',
  'carbs',
  'fat',
  'dietary_fiber',
...
export function getNutrientLabel(
  ...
  switch (key) {
    case 'calories':
      return t('nutrients.calories', { defaultValue: 'Calories' });
    case 'protein':
      return t('nutrients.protein', { defaultValue: 'Protein' });
    case 'carbs':
      return t('nutrients.carbs', { defaultValue: 'Carbs' });
    case 'fat':
      return t('nutrients.fat', { defaultValue: 'Fat' });
    case 'dietary_fiber':
    ...
    case 'polyunsaturated_fat':
      return t('nutrients.polyunsaturatedFatShort', {
        defaultValue: 'Poly. Fat',
      });
    case 'monounsaturated_fat':
      return t('nutrients.monounsaturatedFatShort', {
        defaultValue: 'Mono. Fat',
      });
    case 'trans_fat':
    ...
    default:
      return NUTRIENT_META[key]?.defaultLabel ?? key;
  }
}

                      ...
                      >
                        ...
                        <View className="items-end">
                          <Text className="text-text-primary text-base font-semibold">
                            {ingredientCalories} {t('nutrition.caloriesShort', { defaultValue: 'cal' })}
                          </Text>
                          <Text className="text-text-muted text-sm mt-1">
              ...
              <View className="gap-2">
                <View className="flex-row items-center justify-between">
                  <Text className="text-text-secondary text-base font-medium">{t('mealBuilder.mealTotal', { defaultValue: 'Meal total' })}</Text>
                    ...
                    {formatCaloriesDisplay(totals.calories)} {t('nutrition.caloriesShort', { defaultValue: 'cal' })}
                  </Text>
                </View>
              ...
              {showPerServing ? (
                <View className="gap-2">
                  <View className="flex-row items-center justify-between">
                    ...
                    <Text className="text-text-primary text-base font-semibold text-right">
                      {formatCaloriesDisplay(totals.calories / totalServingsCount)} {t('nutrition.caloriesShort', { defaultValue: 'cal' })}
                    </Text>
                  </View>
                  <View className="flex-row items-start gap-2 mt-1">
                    <MacroStat

...
const cycleGalleryLabel = (
  t: ReturnType<typeof useTranslation>['t'],
  phaseKey: CycleGalleryPhase
): string => {
  switch (phaseKey) {
    case 'menstrual':
      return t('devTools.gallery.state.menstrual', {
        defaultValue: 'Menstrual — day 2',
      });
    case 'follicular':
      return t('devTools.gallery.state.follicular', {
        defaultValue: 'Follicular — day 8',
      });
    case 'fertile':
      return t('devTools.gallery.state.fertile', {
        defaultValue: 'Fertile window — day 12',
      });
    case 'ovulation':
      return t('devTools.gallery.state.ovulation', {
        defaultValue: 'Ovulation — day 14',
      });
    case 'luteal':
      return t('devTools.gallery.state.luteal', {
        defaultValue: 'Luteal — day 21',
      });
    case 'late':
      return t('devTools.gallery.state.late', {
        defaultValue: 'Period late — day 31',
      });
    default:
      return t('devTools.gallery.state.unknown', {
    ...
    try {
      ...
      Toast.show({
        ...
        text2: t('devTools.toast.syncCompleted', {
          defaultValue: 'Background sync completed. Check Logs for details.',
        }),
      });
    } catch (error) {
      ...
      Toast.show({
        ...
        text2: t('devTools.toast.syncFailed', {
          defaultValue: 'Sync failed: {{message}}',
          message,
        }),
      });
    } finally {
  ...
  const handleSeedHistoricalSteps = async () => {
    ...
    try {
      ...
      if (result.success) {
        Toast.show({
          ...
          text2: t('devTools.toast.historicalSeeded', {
            defaultValue:
              'Seeded {{count}} historical step records across the past year.',
            defaultValue_one:
              'Seeded {{count}} historical step record across the past year.',
            defaultValue_other:
              'Seeded {{count}} historical step records across the past year.',
        ...
        Toast.show({
          type: 'error',
          text1: t('common.error', { defaultValue: 'Error' }),
          text2: t('devTools.toast.historicalSeedFailed', {
            defaultValue: 'Failed to seed historical step data.',
          }),
        });
      }
    } catch (error) {
      ...
      Toast.show({
        type: 'error',
        text1: t('common.error', { defaultValue: 'Error' }),
        text2: t('devTools.toast.historicalSeedFailedWithMessage', {
          defaultValue: 'Failed to seed historical step data: {{message}}',
          message,
        }),
      });
    } finally {
  ...
  const handleSeedOldData = async () => {
    ...
    try {
      ...
      if (result.success) {
        Toast.show({
          ...
          text2: t('devTools.toast.seedOldSeeded', {
            defaultValue:
              'Seeded {{count}} records in clusters 1-3 years back.',
            defaultValue_one:
              'Seeded {{count}} record in clusters 1-3 years back.',
            defaultValue_other:
              'Seeded {{count}} records in clusters 1-3 years back.',
            count: result.recordsInserted,
          }),
        ...
        Toast.show({
          type: 'error',
          text1: t('common.error', { defaultValue: 'Error' }),
          text2: t('devTools.toast.seedOldFailed', {
            defaultValue: 'Failed to seed old health data.',
          }),
        });
      }
    } catch (error) {
      ...
      Toast.show({
        type: 'error',
        text1: t('common.error', { defaultValue: 'Error' }),
        text2: t('devTools.toast.seedOldFailedWithMessage', {
          defaultValue: 'Failed to seed old health data: {{message}}',
          message,
        }),
      });
    } finally {
  ...
  const handleSeedData = async (days: number) => {
    ...
    try {
      ...
      if (result.success) {
        Toast.show({
          ...
          text2: t('devTools.toast.healthSeeded', {
            defaultValue:
              'Seeded {{count}} health records for the past {{days}} days.',
            defaultValue_one:
              'Seeded {{count}} health record for the past {{days}} days.',
            defaultValue_other:
              'Seeded {{count}} health records for the past {{days}} days.',
            count: result.recordsInserted,
            days,
        ...
        Toast.show({
          type: 'error',
          text1: t('common.error', { defaultValue: 'Error' }),
          text2: t('devTools.toast.healthSeedFailed', {
            defaultValue: 'Failed to seed health data.',
          }),
        });
      }
    } catch (error) {
      ...
      Toast.show({
        type: 'error',
        text1: t('common.error', { defaultValue: 'Error' }),
        text2: t('devTools.toast.healthSeedFailedWithMessage', {
          defaultValue: 'Failed to seed health data: {{message}}',
          message,
        }),
      });
    } finally {
  ...
  const handleSeedRichWorkout = async () => {
    ...
    try {
      ...
      if (result.success) {
        Toast.show({
          ...
          text2: t('devTools.toast.richWorkoutSeeded', {
            defaultValue:
              'Seeded a 12-minute walk with route, HR, speed and laps. Run a foreground sync to pull it in.',
          }),
        });
      } else {
        Toast.show({
          type: 'error',
          text1: t('common.error', { defaultValue: 'Error' }),
          text2: t('devTools.toast.richWorkoutFailed', {
            defaultValue: 'Failed to seed rich workout.',
          }),
        });
      }
    } catch (error) {
      ...
      Toast.show({
        type: 'error',
        text1: t('common.error', { defaultValue: 'Error' }),
        text2: t('devTools.toast.richWorkoutFailedWithMessage', {
          defaultValue: 'Failed to seed rich workout: {{message}}',
          message,
        }),
      });
    } finally {
  ...
  const handleSeedRichStrengthWorkout = async () => {
    ...
    try {
      ...
      if (result.success) {
        Toast.show({
          ...
          text2: t('devTools.toast.richStrengthSeeded', {
            defaultValue:
              'Seeded a 35-minute strength session with spiky HR (no route/reps — devices never report those). Run a foreground sync to pull it in.',
          }),
        });
      } else {
        Toast.show({
          type: 'error',
          text1: t('common.error', { defaultValue: 'Error' }),
          text2: t('devTools.toast.richStrengthFailed', {
            defaultValue: 'Failed to seed rich strength workout.',
          }),
        });
      }
    } catch (error) {
      ...
      Toast.show({
        type: 'error',
        text1: t('common.error', { defaultValue: 'Error' }),
        text2: t('devTools.toast.richStrengthFailedWithMessage', {
          defaultValue: 'Failed to seed rich strength workout: {{message}}',
          message,
        }),
      });
    } finally {
      ...
      if (result.success) {
        Toast.show({
          ...
          text2: t('devTools.toast.richWorkoutIosSeeded', {
            defaultValue:
              'Seeded a 12-minute walk with route and HR. Run a foreground sync to pull it in.',
          }),
        });
      } else {
        Toast.show({
      ...
      if (result.success) {
        Toast.show({
          ...
          text2: t('devTools.toast.richStrengthIosSeeded', {
            defaultValue:
              'Seeded a 35-minute strength session with spiky HR (no route/laps/reps — devices never report those). Run a foreground sync to pull it in.',
          }),
        });
      } else {
        Toast.show({
  ...
  const handleCheckBackgroundPermissions = async () => {
    ...
    Toast.show({
      ...
      text1: t('devTools.healthConnect.backgroundPermission.title', {
        defaultValue: 'Background Access Permission',
      }),
      text2: hasBackgroundAccess
        ? t('devTools.healthConnect.backgroundPermission.granted', {
            defaultValue: 'Background access permission is granted.',
          })
        : t('devTools.healthConnect.backgroundPermission.notGranted', {
            defaultValue: 'Background access permission is NOT granted.',
          }),
    });
  };
    ...
    <View className="bg-surface rounded-xl p-4 mb-4 shadow-sm">
      ...
      <Text className="text-text-muted mb-3 text-[13px]">
        {t('devTools.description', {
          defaultValue: 'These tools are only visible in development builds.',
        })}
      </Text>

      <Text className="text-sm text-text-primary">
        {t('devTools.seed.title', { defaultValue: 'Seed Health Data' })}
      </Text>
      <Text className="text-text-muted mb-3 text-[13px]">
      ...
      <View className="flex-row gap-2 flex-wrap justify-between">
        ...
        >
          <Text className="text-white text-base font-bold">
            {t('devTools.seed.fourteenDays', { defaultValue: '14 Days' })}
          </Text>
        </Button>
        ...
        >
          <Text className="text-white text-base font-bold">
            {t('devTools.seed.thirtyDays', { defaultValue: '30 Days' })}
          </Text>
        </Button>
        ...
        >
          <Text className="text-white text-base font-bold text-center">
            {t('devTools.seed.oneYear', { defaultValue: '1 Year' })}
            {'\n'}
            {t('devTools.seed.steps', { defaultValue: '(Steps)' })}
          </Text>
        </Button>
        ...
        >
          <Text className="text-white text-base font-bold text-center">
            {t('devTools.seed.oldData', { defaultValue: 'Old Data' })}
            {'\n'}
            {t('devTools.seed.oldRange', { defaultValue: '(1-3 Years)' })}
          </Text>
        </Button>
        ...
        {Platform.OS === 'android' && (
          ...
          >
            <Text className="text-white text-base font-bold text-center">
              {t('devTools.seed.richWorkout', { defaultValue: 'Rich Workout' })}
              {'\n'}
              {t('devTools.seed.richWorkoutDetail', {
                defaultValue: '(Route+HR+Laps)',
              })}
            </Text>
          </Button>
        )}
        ...
        {Platform.OS === 'android' && (
          ...
          >
            <Text className="text-white text-base font-bold text-center">
              {t('devTools.seed.richStrength', {
                defaultValue: 'Rich Strength',
              })}
              {'\n'}
              {t('devTools.seed.richStrengthDetail', {
                defaultValue: '(Spiky HR)',
              })}
            </Text>
          </Button>
        )}
        ...
        {Platform.OS === 'ios' && (
          ...
          >
            <Text className="text-white text-base font-bold text-center">
              {t('devTools.seed.richWorkout', { defaultValue: 'Rich Workout' })}
              {'\n'}
              {t('devTools.seed.richWorkoutIosDetail', {
                defaultValue: '(Route+HR)',
              })}
            </Text>
          </Button>
        )}
      ...
      <View className="mt-5">
        <Text className="text-sm text-text-primary">
          {t('devTools.sync.title', { defaultValue: 'Background Sync' })}
        </Text>
        <Text className="text-text-muted mb-3 text-[13px]">
          {t('devTools.sync.description', {
            defaultValue: 'Manually trigger the background sync process.',
          })}
        </Text>
        <View className="flex-row gap-2 flex-wrap justify-between">
          <Button
            ...
            >
              <Text className="text-white text-base font-bold">
                {t('devTools.sync.checkPermission', {
                  defaultValue: 'Check BG Permission',
                })}
              </Text>
            </Button>
          )}
      ...
      <View className="mt-5">
        <Text className="text-sm text-text-primary">
          {t('devTools.auth.title', { defaultValue: 'Auth' })}
        </Text>
        <Text className="text-text-muted mb-3 text-[13px]">
          {t('devTools.auth.description', {
            defaultValue: 'Trigger auth modals for testing.',
          })}
        </Text>
        <View className="flex-row gap-2 flex-wrap">
          ...
          >
            <Text className="text-white text-base font-bold">
              {t('devTools.auth.reauth', { defaultValue: 'Show ReauthModal' })}
            </Text>
          </Button>
        </View>
      </View>
      ...
      <View className="mt-5">
        <Text className="text-sm text-text-primary">
          {t('devTools.whatsNew.title', { defaultValue: "What's New Banner" })}
        </Text>
        <Text className="text-text-muted mb-3 text-[13px]">
            ...
            onPress={async () => {
              ...
              Toast.show({
                ...
                text2: t('devTools.toast.whatsNewReset', {
                  defaultValue: "What's New banner will re-appear.",
                }),
              });
            }}
          >
            <Text className="text-white text-base font-bold">
              {t('devTools.whatsNew.reset', { defaultValue: 'Reset Banner' })}
            </Text>
          </Button>
        </View>
      </View>
              ...
              try {
                ...
                Toast.show({
                  ...
                  text2: t('devTools.toast.announcementReset', {
                    defaultValue: 'System announcement modal will re-appear.',
                  }),
                });
              } catch {
                Toast.show({
                  ...
                  text2: t('devTools.toast.announcementResetFailed', {
                    defaultValue: 'Could not reset announcement.',
                  }),
                });
              }
            }}
          >
            <Text className="text-white text-base font-bold">
              {t('devTools.announcement.reset', {
                defaultValue: 'Reset Announcement',
              })}
            </Text>
          </Button>
        </View>
      ...
      <View className="mt-5">
        <Text className="text-sm text-text-primary">
          {t('devTools.gallery.title', { defaultValue: 'Cycle Card Gallery' })}
        </Text>
        <Text className="text-text-muted mb-3 text-[13px]">
          {t('devTools.gallery.description', {
            defaultValue:
              'Fake-data preview of the dashboard cycle card in every phase. The pregnancy and discreet layouts follow real data: switch mode in Hub settings.',
          })}
        </Text>
        {CYCLE_GALLERY_STATES.map(({ phaseKey, info }) => (
          <View key={phaseKey} className="mb-3">
            ...
            <View className="border border-border-subtle rounded-xl p-4">
              <CycleCardRingContent
                title={t('devTools.gallery.cycleTracking', {
                  defaultValue: 'Cycle Tracking',
                })}
                info={info}
              />
            </View>

  ...
  return (
    <View className="bg-surface rounded-xl p-4 mb-3 shadow-sm">
      <View className="flex-row items-center justify-center">
        <SideStat label={t('calorieCard.consumed')} value={caloriesConsumed} />
        ...
        <View className="relative items-center justify-center mx-2">
          ...
          <View className="absolute items-center justify-center">
            ...
            <Text className="text-text-secondary text-xs">
               {t('calorieCard.remaining')}
            </Text>
            <Text className="text-text-muted text-xs mt-0.5">
               {t('calorieCard.ofGoal', {
                 goal: formatLocalizedNumber(calorieGoal),
                 unit: t('units.kcalShort'),
               })}
            </Text>
          </View>
        </View>

        <SideStat label={t('calorieCard.burned')} value={caloriesBurned} />
      </View>
    </View>
  );
};

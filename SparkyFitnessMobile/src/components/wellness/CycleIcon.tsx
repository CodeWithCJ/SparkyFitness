...
const CycleIcon: React.FC<CycleIconProps> = ({ id, size = 28 }) => {
  ...
  // Theme-aware icon tile fill (transparent so glyph sits naturally in card/raised containers)
  const tileBg = tokens.surfaceTint || 'none';
  ...
  const renderIconContent = () => {
    switch (id) {
      case 'flow-none':
        return (
          <>
            <Rect width="28" height="28" rx="8" fill={tileBg} />

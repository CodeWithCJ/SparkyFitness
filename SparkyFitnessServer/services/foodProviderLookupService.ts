...
// Moved to providerFoodRanking so the search service can rank too, without the
// two services importing each other (#2418). Re-exported because the chatbot
// tools, the photo matcher and the tests all reach for them here.
export {
  rankProviderMatches,
  type ProviderFoodVariant,
  type ProviderFoodItem,

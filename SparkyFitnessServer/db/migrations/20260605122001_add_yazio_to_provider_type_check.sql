-- Add 'yazio' to the allowed provider_type values in external_data_providers
...
CHECK (provider_type IN ('fatsecret', 'openfoodfacts', 'mealie', 'garmin', 'health', 'nutritionix', 'wger', 'free-exercise-db', 'withings', 'tandoor', 'usda', 'yazio'));

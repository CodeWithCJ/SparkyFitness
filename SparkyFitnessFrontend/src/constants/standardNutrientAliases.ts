...
const STANDARD_NUTRIENT_ALIASES: Record<string, string[]> = {
  ...
  fat: ['fat', 'fats', 'total fat', 'total lipid fat'],
  saturated_fat: ['saturated fat', 'saturated', 'fatty acids total saturated'],
  polyunsaturated_fat: [
    'polyunsaturated fat',
    'polyunsaturated',
  ...
  sugars: ['sugars', 'sugar', 'total sugars', 'sugars total including nlea'],
  vitamin_a: ['vitamin a', 'vitamin a rae'],

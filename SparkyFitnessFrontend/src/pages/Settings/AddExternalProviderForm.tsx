      ...
      if (newProvider.provider_type === 'garmin') {
        ...
        data = await apiCall('/external-providers', {
          ...
          body: JSON.stringify({
            ...
            app_id: (newProvider.provider_type === 'mealie' || newProvider.provider_type === 'tandoor' || newProvider.provider_type === 'free-exercise-db' || newProvider.provider_type === 'wger' || newProvider.provider_type === 'usda') ? null : newProvider.app_id || null,
            ...
            sync_frequency: ['withings', 'garmin', 'fitbit'].includes(newProvider.provider_type) ? newProvider.sync_frequency : null,
          }),
        });
      }
    ...
    <>
      ...
      {showAddForm && (
        <form onSubmit={(e) => { e.preventDefault(); handleAddProvider(); }} className="border rounded-lg p-4 space-y-4">
          ...
          {(newProvider.provider_type === 'withings' || newProvider.provider_type === 'garmin' || newProvider.provider_type === 'fitbit') && (
            <div>

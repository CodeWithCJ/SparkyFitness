...
const CustomNutrientsSettings: React.FC = () => {
    ...
    const [editingNutrient, setEditingNutrient] = useState<UserCustomNutrient | null>(null);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="p-4 border rounded-md shadow-sm">
                <h3 className="text-xl font-semibold mb-4">Existing Custom Nutrients</h3>
                    ...
                    <Table>
                        ...
                        <TableBody>
                                                         {customNutrients && customNutrients.map((nutrient) => (
                                    ...
                                    <TableCell>
                                        {editingNutrient?.id === nutrient.id ? (
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    setEditingNutrient({ ...editingNutrient, name: e.target.value })
                                                }
                                            />
                                        ) : (
                                            nutrient.name
                                    ...
                                    <TableCell>
                                        {editingNutrient?.id === nutrient.id ? (
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    setEditingNutrient({ ...editingNutrient, unit: e.target.value })
                                                }
                                            />
                                        ) : (
                                            nutrient.unit
                                    ...
                                    <TableCell className="text-right">
                                        {editingNutrient?.id === nutrient.id ? (
                                            <>
                                                                                                ...
                                                                                                <Button variant="ghost" onClick={() => setEditingNutrient(null)}>
                                                                                                    Cancel
                                                                                                </Button>
                                                                                            </>
                                                                                        ) : (
                                                                                            <div className="flex items-center space-x-2">
                                                                                                <Button variant="ghost" size="icon" onClick={() => setEditingNutrient(nutrient)} title="Edit">
                                                                                                    ...
                                                                                                    <AlertDialogContent>
                                                                                                        <AlertDialogHeader>
                                                                                                            ...
                                                                                                            <AlertDialogDescription>
                                                                                                                ...
                                                                                                                custom nutrient and remove its values from all associated foods and entries.
                                                                                                            </AlertDialogDescription>
                                                                                                        </AlertDialogHeader>
                                                                                                        <AlertDialogFooter>
                                                                                                            <AlertDialogCancel>Cancel</AlertDialogCancel>
                                                                                                            <AlertDialogAction onClick={() => handleDeleteNutrient(nutrient.id)}>
                                                                                                                Delete
                                                                                                            </AlertDialogAction>
                                                                                                        </AlertDialogFooter>
                                                                                                    </AlertDialogContent>

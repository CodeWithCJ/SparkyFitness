        ...
        <div>
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400">
            {exerciseEntry.exercise_snapshot?.name === 'Active Calories'
              ...
              : `${formatMinutesToHHMM(exerciseEntry.sets?.reduce((sum, set) => sum + (set.duration || 0), 0) || exerciseEntry.duration_minutes || 0)} • ${Math.round(convertEnergy(exerciseEntry.calories_burned || 0, 'kcal', energyUnit))} ${getEnergyUnitString(energyUnit)}`}
            {exerciseEntry.sets &&

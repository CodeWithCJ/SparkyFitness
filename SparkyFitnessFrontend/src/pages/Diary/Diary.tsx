...
const Diary = () => {
  ...
  // Handle navigation for opening food search dialog (from log-food-quick-actions)
  useEffect(() => {
    const state = location.state as { openFoodSearchForMeal?: string };
    console.log('[Diary] Location state:', state);
    if (state?.openFoodSearchForMeal && availableMealTypes && availableMealTypes.length > 0) {

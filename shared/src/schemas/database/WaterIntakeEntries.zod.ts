...
export type WaterIntakeEntriesInitializer = z.infer<
  typeof waterIntakeEntriesInitializerSchema
>;
export type WaterIntakeEntriesMutator = z.infer<
  typeof waterIntakeEntriesMutatorSchema
>;

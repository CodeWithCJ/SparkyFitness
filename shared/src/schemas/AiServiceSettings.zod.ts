...
export const aiServiceSettingsSchema = z.object({
  ...
  api_key_iv: z.string().nullable(),
  api_key_tag: z.string().nullable(),
  is_public: z.boolean(),
});
...
export type AiServiceSettingsInitializer = z.infer<typeof aiServiceSettingsInitializerSchema>;
export type AiServiceSettingsMutator = z.infer<typeof aiServiceSettingsMutatorSchema>;
